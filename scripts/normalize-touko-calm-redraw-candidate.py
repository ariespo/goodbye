"""Normalize Touko's revised calm candidate to the shared monochrome canvas."""
...
ASSET_ROOT = ROOT / "public" / "assets" / "characters" / "candidates" / "touko-calm-redraw-v1"
...
def main() -> None:
    ...
    print(f"final_bbox={normalized.getchannel('A').getbbox()}")

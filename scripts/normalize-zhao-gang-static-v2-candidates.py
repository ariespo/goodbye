"""Normalize Zhao Gang v2 static candidates to the shared large-half-body canvas."""
...
ASSET_ROOT = ROOT / "public" / "assets" / "characters" / "candidates" / "zhao-gang-static-v2"
...
def scaled(image: Image.Image) -> Image.Image:
    ...
    strictly_monochrome = Image.merge("RGBA", (grayscale, grayscale, grayscale, rgba.getchannel("A")))
    return strictly_monochrome.resize(TARGET_SIZE, Image.Resampling.NEAREST)

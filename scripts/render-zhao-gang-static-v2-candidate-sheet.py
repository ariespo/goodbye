"""Render a review sheet for Zhao Gang's v2 static candidates."""
...
SOURCE_ROOT = ROOT / "public" / "assets" / "characters" / "candidates" / "zhao-gang-static-v2" / "normalized"
OUTPUT_PATH = ROOT / "tmp" / "zhao-gang-static-v2-contact-sheet.png"
EMOTIONS = ("calm", "sad")
CELL = (296, 640)
PADDING = 18
LABEL_HEIGHT = 28

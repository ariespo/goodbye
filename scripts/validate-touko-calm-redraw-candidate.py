"""Validate Touko's revised calm candidate, including its connected silhouette."""
...
PATH = ROOT / "public" / "assets" / "characters" / "candidates" / "touko-calm-redraw-v1" / "normalized" / "touko-calm.png"
...
def main() -> None:
    with Image.open(PATH) as image:
        ...
        print(f"alpha_bbox={bbox}, largest_component_ratio={connected_ratio:.5f}")

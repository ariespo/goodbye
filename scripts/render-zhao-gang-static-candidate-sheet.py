"""Render a review sheet for Zhao Gang's normalized static candidates."""
...
SOURCE_ROOT = ROOT / "public" / "assets" / "characters" / "candidates" / "zhao-gang-static-v1" / "normalized"
OUTPUT_PATH = ROOT / "tmp" / "zhao-gang-static-v1-contact-sheet.png"
EMOTIONS = ("calm", "sad")
CELL = (296, 640)
PADDING = 18
LABEL_HEIGHT = 28
...
def main() -> None:
    ...
    for index, emotion in enumerate(EMOTIONS):
        with Image.open(SOURCE_ROOT / f"zhao-gang-{emotion}.png") as source:

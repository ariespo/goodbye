"""Render Touko's original and v2 calm redraw for review."""
...
CANDIDATE_PATH = ROOT / "public" / "assets" / "characters" / "candidates" / "touko-calm-redraw-v2" / "normalized" / "touko-calm.png"
OUTPUT_PATH = ROOT / "tmp" / "touko-calm-redraw-v2-comparison.png"
CELL = (296, 640)
PADDING = 18
LABEL_HEIGHT = 28
...
def main() -> None:
    ...
    for index, (label, path) in enumerate((("CURRENT", CURRENT_PATH), ("CANDIDATE V2", CANDIDATE_PATH))):

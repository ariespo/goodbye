...
export const backgroundAssets: BackgroundAsset[] = [
  ...
  },
  {
    ...
    description: '旧版诊室与文穗幽影画面；保留文件，当前结局不自动使用。',
    usage: 'C-1 旧版结局画面',
    priority: 'existing',
  ...
  },
  {
    ...
    file: 'ending-f-1.png',
    displayName: '结局：放她走',
    description: '旧版车站与文穗对视画面；保留文件，当前结局不自动使用。',
    usage: 'F-1 旧版结局画面',
    priority: 'existing',
  ...
  },
  {
    ...
    displayName: '结局：困局',
    description: '旧版空白笔记本与九点钟画面；保留文件，当前结局不自动使用。',
    usage: 'LOOP 旧版结局画面',
    priority: 'existing',
  ...
  },
  {
    ...
    description: '旧版文穗在桌边与九点钟画面；保留文件，当前结局不自动使用。',
    usage: 'STAY 旧版结局画面',
    priority: 'existing',
  ...
  },
  {
    ...
    displayName: '旧版结局画面：九点零一分',
    description: '旧版告别与九点零一分画面；保留文件，当前结局改用空屋表现记忆告别。',
    usage: 'TRUE 旧版结局画面',
    priority: 'existing',

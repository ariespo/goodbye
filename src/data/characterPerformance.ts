...
export const CHARACTER_PERFORMANCE_PROFILES: readonly CharacterPerformanceProfile[] = [
  ...
  },
  {
    ...
    role: '不擅长与人交往的便利店员；想显得热情友善，过度用力后反而令人不自在。',
    actionRules: ['会提前记住常客偏好、整理货架或多塞一点赠品，把实际照料当作社交替代品。', '紧张时维持固定笑容、重复服务用语并过度说明商品或小票细节。', '她总随手抱着看似文件夹的扁平物件；在玩家取得对应认知前，不得主动解释那是大号巧克力。'],
    reactionRules: ['被感谢时会僵住并迅速转回工作话题；被怀疑时先慌乱地列举细节，显得更可疑。', '确认对方真正在倾听后才会承认自己不擅长说话，语气会明显自然一些。'],
    dialogueRules: ['常使用便利店服务话术，随后补上一句过于具体的私人观察；不是故意窥探，而是记忆细节的方式缺乏分寸。', '句子会出现重复、补充和笨拙改口，不使用阴森隐喻。'],
    ...
    forbiddenPortrayals: ['不得把她写成跟踪狂、恶意窥私者或隐藏凶手。', '不得把社交笨拙写成智力低下，也不得用固定笑容直接证明犯罪。'],
  },
  {
    id: 'liu-renguang',

 ...
 *
 * 暴雨第五天。家中无人应答，玩家从桌上的早餐、纸条和账号消息里
...
export const OPENING_PUBLIC_CONTINUITY = [
  ...
  { id: 'opening-breakfast', text: '玩家今早在餐桌上看到切去面包皮的三明治和已经凉了的牛奶，家中无人应答；是谁、何时准备和摆放的尚未核实。' },
  { id: 'opening-note', text: '玩家今早看到杯底压着一张纸条，原文是“公交卡在外层口袋！今天可能晚一点回来。”署名旁画着猫，尾巴延到纸背；纸条没有写日期或目的地，何时写下尚未核实。' },
  { id: 'opening-message-0650', text: '玩家今早在文穗账号的聊天框中看到一条消息，显示时间为06:50：“我先出门了，今天不去学校。晚饭不用等我，回来再跟你说。”这是消息中的自述安排；是否由她本人在该时刻发送尚未核实，也尚未核实学校请假或她的去向。' },
...
对话|旁白|calm|你掀开盘子。面包有一角粘在盘底，你小心地把它揭下来。面包皮已经切掉了。你想起文穗做三明治时，总有这个习惯。
...
对话|旁白|calm|你点开文穗的聊天框。最新的一条消息旁显示着六点五十。

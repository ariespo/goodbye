...
describe('action narrative context semantic planning', () => {
  it.each([
    ...
    ['前往社区便利店向店员陈慧慧打听文穗的去向', 'supermarket'],
    ['冒着暴雨前往社区便利店打听文穗今晨去向', 'supermarket'],
    ['前往附近文穗常去的社区便利店询问店员陈慧慧', 'supermarket'],
    ['前往文穗平时常去的便利店打听消息', 'supermarket'],
    ['前往旧居民楼向周大爷打听早晨的见闻', 'old-man-building'],
